    ...
    <Card className="shadow-card">
      <CardHeader className="pb-2 flex flex-row items-center justify-between">
        <div className="flex items-center">
          ...
          <CardTitle className="text-lg">Eli - Energy AI Assistant</CardTitle>
        </div>
        <div className="flex items-center">
          <Button 
            variant={aiEnabled ? "default" : "outline"} 
            size="sm"
            className={aiEnabled ? "bg-electricblue text-white mr-2" : "mr-2"}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem>Configure Eli</DropdownMenuItem>
              <DropdownMenuItem>View Learning Model</DropdownMenuItem>
              <DropdownMenuItem>Reset Preferences</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
          <div className="border rounded-lg p-3">
            <div className="text-sm text-gray-500 mb-1">Energy Cost Savings</div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium">{energySavings}%</span>
            </div>
          </div>
          
          <div className="border rounded-lg p-3">
            <div className="text-sm text-gray-500 mb-1">Battery Optimization</div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium">{batteryOptimization}%</span>
            </div>
          </div>
          ...
          <div className="border rounded-lg p-3 flex items-center">
            ...
            <div>
              <div className="text-sm text-gray-500">Current Action</div>
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm text-electricblue cursor-pointer hover:underline">
              View All
            </span>
          </div>
            ...
            {recommendations.map((rec) => (
              ...
              >
                <div className="flex justify-between">
                  <h4 className={`font-medium ${rec.completed ? 'line-through text-gray-400' : ''}`}>
                    {rec.title}
                  </h4>
                ...
                <p className={`text-sm ${rec.completed ? 'text-gray-400' : 'text-gray-600'}`}>
                  {rec.description}
                </p>
              </div>
            ))}
